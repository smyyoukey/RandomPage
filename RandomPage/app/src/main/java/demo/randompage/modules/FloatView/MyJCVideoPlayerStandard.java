...
import demo.randompage.modules.main.DetailActivity;

import static demo.randompage.modules.ThirdView.player.JCVideoPlayer.SCREEN_WINDOW_FULLSCREEN;
...
//                intent.putExtra(DetailActivity.class,);
            }
        }
    }
